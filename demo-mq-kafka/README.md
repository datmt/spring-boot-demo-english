...
> This demo mainly demonstrates how Spring Boot integrates kafka to send and receive messages.

## Environment preparation

> Note: This demo is based on Spring Boot 2.1.0.RELEASE version, so spring-kafka is version 2.2.0.RELEASE and kafka-clients is version 2.0.0, so the version of kafka is selected as kafka_2.11-2.1.0
...
1. Spring Boot version and Spring-Kafka version correspondence: https://spring.io/projects/spring-kafka
...
2. Spring-Kafka Official Documentation: https://docs.spring.io/spring-kafka/docs/2.2.0.RELEASE/reference/html/
